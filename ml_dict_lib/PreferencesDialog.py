...
class PreferencesDialog(Gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesMlDictDialog')
        new_object = builder.get_object("preferences_ml_dict_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesMlDictDialog
        instance.
